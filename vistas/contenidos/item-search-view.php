...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo serve_url ?>item-search/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ITEM</a>
        </li>
    </ul>
</div>
        ...
        <table class="table table-dark table-sm">
            ...
            <tbody>
                <tr class="text-center" >
                    ...
                    <td>
                        <a href="<?php echo serve_url ?>item-update/" class="btn btn-success">
