<?php
    ...
    class mainModel{
        ...
        protected static function validar_fechas($fecha){
        ...
        protected static function paginador_tablas($pagina_actual, $numero_paginas, $url, $botones){
            ...
            for($i=$pagina; $i <=$numero_paginas; $i++){
                ...
                if($pagina==$i){
                    ...
                    $tabla.='<li class="page-item"><a class="page-link" href="'.$url
                        .$i.'/">'.$i.'</a></li>';
                }
                $ci++;
            }
            ...
            if($pagina==$numero_paginas){
                ...
                <li class="page-item"><a class="page-link" href="'.$url.($pagina-1).'
                /">Siguiente</a></li>
                <li class="page-item"><a class="page-link" href="'.$url.$numero_paginas.'1/"><i
                class="fa-solid fa-angles-left"></i></a></li>'
                ;
            }
